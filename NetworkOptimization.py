...
def cross_validation(X_train, Y_train, X_validation, Y_validation):
    """
    Trains a network with different hyper parameters and evaluates it's performance.
    """
...
def accuracy_of_hyper_params(times_trained, X_validation, Y_validation,
    ...
    for i in range(times_trained):
        network, accuracy_accross_epochs = train_network(hidden_layers, learning_rate, epochs, hidden_nodes, X_train, Y_train, init_weight,
                                                         init_bias)
...
def train_network_different_initial_weights(X_train, Y_train, X_validation, Y_validation):
    """
    Trains a network 10 times with different initial weights and plots the performance of each network.
    """
...
def train_network_different_hidden_layers(X_train, Y_train, X_validation, Y_validation):
    """
    Trains a network with different hidden layers, evaluates the performance and returns the best amount of layers.
    """
...
def train_network_different_hidden_neurons(X_train, Y_train, X_validation, Y_validation):
    """
    Trains a network with different hidden neurons, evaluates the performance and returns the best amount of neurons.
    """
...
def network_architecture_performance(hidden_layers, learning_rate, epochs, hidden_nodes,
    ...
    """
    Trains a network with the given architecture and plots the performance across epochs.
    """
